...
public class ModReloadThread extends Thread {
    /**
     ...
     */
    private static volatile ModReloadThread instance;
    ...
    public static void addPendingPlugin(PluginIdentifier pluginId) {
        ...
        ModReloadThread currentInstance = instance;
